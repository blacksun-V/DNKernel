...
OBJS = $(SOURCE)/kernel.o $(SOURCE)/framebuffer.o $(SOURCE)/screen.o $(SOURCE)/boot.o $(SOURCE)/asmfunc.o $(SOURCE)/idt.o $(SOURCE)/gdt.o $(SOURCE)/pic.o $(SOURCE)/phy_mem.o $(SOURCE)/vm.o $(SOURCE)/common.o $(SOURCE)/isr.o $(SOURCE)/int.o
